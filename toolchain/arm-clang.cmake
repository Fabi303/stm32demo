...
# -fno-exceptions / -fno-rtti: select the no-unwind libc++ runtime variant so
# that libunwind (which references __exidx_start/__exidx_end discarded by the
# modm linker script) is never linked.
set(CMAKE_CXX_FLAGS_INIT           "--target=arm-none-eabi ${_CPU_FLAGS} -fno-exceptions -fno-rtti")
set(CMAKE_ASM_FLAGS_INIT           "--target=arm-none-eabi ${_CPU_FLAGS}")
# Pass -fno-exceptions to the linker driver so it also picks the correct runtime.
# --defsym: picolib's sbrk needs __heap_start/__heap_end; set both to 0 for
# heapless operation (sbrk returns -1 immediately, malloc never succeeds).
set(CMAKE_EXE_LINKER_FLAGS_INIT
    "-fuse-ld=lld -fno-exceptions -fno-rtti \
